...
def get_qt_text_templates(package):
    ...
    templates['manifest.xml'] = read_template(os.path.join(roslib.packages.get_pkg_dir('eros_python_tools'),'templates','qt','manifest.xml'))
    ...
    templates[os.path.join('src','main.cpp')] = read_template(os.path.join(roslib.packages.get_pkg_dir('eros_python_tools'),'templates','qt','src','main.cpp'))
    templates[os.path.join('src','main_window.cpp')] = read_template(os.path.join(roslib.packages.get_pkg_dir('eros_python_tools'),'templates','qt','src','main_window.cpp'))
    ...
    templates[os.path.join('include',package,'main_window.hpp')] = read_template(os.path.join(roslib.packages.get_pkg_dir('eros_python_tools'),'templates','qt','include','PACKAGE_NAME','main_window.hpp'))
    return templates
