...
set(PLATFORM_COMPILE_FLAGS "-march=prescott -mtune=generic -pipe -fomit-frame-pointer -mfpmath=sse -mmmx -msse -msse2 -mssse3" CACHE STRING "Compile flags specific to this platform.")
